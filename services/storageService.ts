...
const DB_KEY_USER_TRACKS_PREFIX = 'top_cargo_user_tracks'; 
const DB_KEY_SETTINGS = 'top_cargo_settings';
const DB_KEY_USER_PROFILE = 'top_cargo_user_profile';
const DB_KEY_ALL_REGISTRATIONS = 'top_cargo_admin_registrations';
