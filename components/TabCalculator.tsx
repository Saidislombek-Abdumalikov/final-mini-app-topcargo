  ...
  return (
    <div className="flex flex-col h-full animate-fade-in pb-32 overflow-y-auto no-scrollbar">
      ...
      <div className="flex flex-col gap-4">
          ...
          {/* 2. Result Card (PURPLE GRADIENT) */}
          <div className="bg-gradient-to-br from-[#48006b] to-[#280e35] rounded-3xl p-5 text-white shadow-lg shadow-purple-900/30 relative overflow-hidden shrink-0">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-10 -mt-10 blur-2xl"></div>
              
              <div className="relative z-10 flex flex-col items-center justify-center py-2">
                  <span className="text-[10px] font-medium text-purple-100 uppercase tracking-widest mb-1">Jami Hisob</span>
                  
                  <div className="flex items-start justify-center gap-1">
                      <span className="text-2xl font-bold mt-1 text-purple-200">$</span>
