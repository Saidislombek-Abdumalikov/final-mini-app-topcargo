...
const TabHome: React.FC<TabHomeProps> = ({ onNavigate }) => {
  ...
  const getAddressData = () => {
      ...
      // Normalize prefix to TOP, but respect legacy JEK/JK/TT if present for display, 
      // however for the address generation, we standardise to TOP to match new branding
  ...
  return (
    <div className="space-y-4 pb-32 animate-fade-in">
      ...
      {/* Address Card (Clickable) - TOP CARGO BRANDED */}
      <div 
        onClick={() => setShowAddressModal(true)}
        className="w-full relative overflow-hidden bg-gradient-to-br from-[#48006b] to-[#280e35] rounded-[24px] p-5 text-white shadow-xl shadow-purple-900/20 group cursor-pointer active:scale-[0.98] transition-all hover:shadow-2xl hover:shadow-purple-900/30"
      >
        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full -mr-16 -mt-16 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-purple-400/20 rounded-full -ml-8 -mb-8 blur-2xl"></div>
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                 <span className="block font-bold leading-none text-white/90 text-sm">TOP ID</span>
                 <span className="text-[9px] text-purple-200 font-medium">Shaxsiy Raqam</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between border-t border-white/10 pt-3">
            <div className="flex items-center gap-2 text-purple-100 text-[10px] font-bold uppercase tracking-wide">
                      ...
                      <div className="bg-white p-5 rounded-[24px] shadow-sm border border-gray-200">
                          ...
                          <div className="relative group">
                              ...
                              <button 
                                ...
                                className={`absolute top-2 right-2 p-2 rounded-lg transition-all shadow-sm border active:scale-95 ${copyFeedback ? 'bg-green-50 border-green-200 text-green-600' : 'bg-white border-gray-200 text-primary hover:bg-purple-50'}`}
                              >
                                 {copyFeedback ? (
