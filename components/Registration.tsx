        ...
        <div className="fixed inset-0 bg-slate-900 z-[100] flex flex-col items-center justify-center p-8 animate-fade-in">
            ...
            <form onSubmit={handleAdminSubmit} className="w-full max-w-xs space-y-4">
                <input 
                    ...
                    className="w-full p-4 bg-slate-800 border border-slate-700 rounded-2xl focus:border-purple-500 outline-none text-center text-xl text-white tracking-widest placeholder:text-slate-600"
                    autoFocus
                />
                {error && <p className="text-red-400 text-sm text-center font-medium">{error}</p>}
                <button type="submit" className="w-full py-4 bg-purple-600 text-white rounded-2xl font-bold shadow-xl shadow-purple-900/20 active:scale-95 transition-transform">Kirish</button>
    ...
    <div className="fixed inset-0 bg-[#F5F7FA] z-[100] flex flex-col items-center justify-center p-6 animate-fade-in safe-area-bottom">
      <div className="w-full max-w-sm bg-white p-8 rounded-[40px] shadow-soft">
        ...
        <div className="text-center mb-8">
           ...
           <h1 className="text-2xl font-black text-primary-dark">TOP CARGO</h1>
